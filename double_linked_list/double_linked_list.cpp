...
void DoubleLinkedList::hapus() {
	...
	cout << "\nEnter the roll number of the strudent whose record is to be delete: ";
	int rollNo;
	cin >> rollNo;
	cout << endl;
...
int main() {
	...
	while (true) {
		try {
			...
			cout << "3. View all record in the asscending order of roll numbers" << endl;
			cout << "4. View all record in the descending in the list" << endl;
